...
class OrderServiceImplTest {
    ...
    void getOrdersTest() {
        val page = 0;
        val size = 10;
        val resultByStatus = orderService.getOrders(OrderStatus.PREPARING, null, page, size);

        assertEquals(0, resultByStatus.getTotalElements());

        val resultByUserId = orderService.getOrders(null, 1L, page, size);

        assertEquals(0, resultByUserId.getTotalElements());

        val resultAll = orderService.getOrders(null, null, page, size);

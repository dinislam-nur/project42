        ...
        return (
            <Navbar>
                <Navbar.Group align={"left"}>
                    ...
                    <Navbar.Divider/>
                    <Button id={"home"} icon="home" minimal={true} onClick={()=>this.props.history.push('/')}/>
                    {/*<Button id={"orders"} icon="list-columns" minimal={true}/>*/}
                </Navbar.Group>
                <Navbar.Group align={"right"}>
                    <Button id={"settings"} icon="cog" minimal={true} onClick={()=>this.props.history.push('/settings')}/>
                    <Navbar.Divider/>

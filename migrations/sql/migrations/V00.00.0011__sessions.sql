...
(
    ...
    CONSTRAINT fk_sessions_tables_table_id FOREIGN KEY (table_id) REFERENCES tables (table_id),
    CONSTRAINT fk_sessions_users_user_id FOREIGN KEY (user_id) REFERENCES users (user_id)
);